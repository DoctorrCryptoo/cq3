...
import image from "./img/Group 48.png";
 ...
 import image4 from"./img/Group 23.png" ;
 import image5 from"./img/Register.png";
 import image6 from"./img/image 84.png"
 

const Footer = () => {
  return <section id="footer" className="relative">
  ...
  <ul className="flex space-x-10 text-white text-3xl">
    <li>
      <a href="#about" className="hover:underline cursor-pointer relative group">
        About
    ...
    <li>
      <a href="#sponsor" className="hover:underline cursor-pointer relative group">
        Sponsors
        <span className="absolute left-0 -bottom-1 w-full h-1 bg-gray-300 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300"></span>
      </a>
    </li>
    <li>
      <a href="#prizes" className="hover:underline cursor-pointer relative group">
        Prizes
        <span className="absolute left-0 -bottom-1 w-full h-1 bg-gray-300 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300"></span>
      </a>
    </li>
    <li>
      <a href="#timeline" className="hover:underline cursor-pointer relative group">
        Timeline
        <span className="absolute left-0 -bottom-1 w-full h-1 bg-gray-300 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300"></span>
      </a>
    </li>
