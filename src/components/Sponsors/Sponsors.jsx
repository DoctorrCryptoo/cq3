		...
		<div id="sponsors">
			...
			<div className="flex flex-wrap justify-center gap-4 p-4 mx-4">
				<div>
					...
					<p className="font-bluu text-[#C90909] text-xl md:text-4xl text-center text-nowrap">
						And that's Anime
					</p>
				</div>
				<div>
					<img src={Yellow} className="max-h-[250px] md:max-h-[550px] max-w-[350px]" loading="lazy"/>
					<p className="font-bluu text-[#FBD702] text-xl md:text-4xl text-center text-nowrap">
						Rasoe
					</p>
				</div>
				<div>
					<img src={Blue} className="max-h-[250px] md:max-h-[550px] max-w-[350px]" loading="lazy"/>
					<p className="font-bluu text-[#00587E] text-xl md:text-4xl text-center text-nowrap">
						Interview Cake
					</p>
				</div>
				<div>
					<img src={Green} className="max-h-[250px] md:max-h-[550px] max-w-[350px]" loading="lazy"/>
					<p className="font-bluu text-[#1D7239] text-xl md:text-4xl text-center text-nowrap">
						Chocoff
					</p>
				</div>
			</div>
